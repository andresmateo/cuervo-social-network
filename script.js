const urlBase = "https://jsonplaceholder.typicode.com/posts" //es la URL con la que interactuamos
...
function getData() {
    fetch(urlBase)
        ...
        .then(data => {
            posts = data
            // metodo para mostrar la información en pantalla
            renderPostList();
        })
...
function deletePost(id){
    ...
    .then(res => {
        if(res.ok){
            ...
            alert("Hubo un error. No se pudo eliminar el posteo.");
        }
    })
